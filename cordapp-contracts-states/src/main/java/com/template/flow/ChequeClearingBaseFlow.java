 ...
 */
abstract class ChequeClearingBaseFlow extends FlowLogic<SignedTransaction> {
    ...
    StateAndRef<ChequeBookState> getObligationByLinearId(UniqueIdentifier linearId) throws FlowException {
        ...
        List<StateAndRef<ChequeBookState>> obligations = getServiceHub().getVaultService().queryBy(ChequeBookState.class, queryCriteria).getStates();
